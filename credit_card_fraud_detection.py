...
# Load the dataset
data = pd.read_csv('./DataSets/CreditCardData.csv')
...
# Call the preprocess_data function to get the training and test datasets
...
lr_model = LogisticRegression(max_iter=2000, solver='lbfgs', C=0.1)
lr_model.fit(X_train, y_train)

# Evaluate the Logistic Regression model (you might need to define the evaluate_model function or remove it if it's not used)
