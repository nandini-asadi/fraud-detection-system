...
# %%
# Load the datasetv'
data = pd.read_csv('./DataSets/transaction_dataset.csv')
...
# Load the dataset
file_path = './DataSets/transaction_dataset.csv'
...
best_model = max(models, key=lambda model: f1_score(y_test, model.predict(X_test)))
